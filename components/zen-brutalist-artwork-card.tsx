...
export function ZenBrutalistArtworkCard({
  ...
  const cardVariants = {
    zen: {
      ...
      moderate:
        'ink-glass-primary rounded-none p-zen-lg hover:shadow-zen-float transition-all duration-700',
      maximum:
        'ink-glass-elevated rounded-lg p-zen-md transform-gpu hover:scale-[1.02] transition-all duration-500',
    },
    brutal: {
      minimal: 'bg-paper brutal-border brutal-shadow p-zen-md',
      moderate:
        'bg-paper-warm brutal-border brutal-shadow hover:brutal-shadow-strong transform hover:rotate-1 transition-all duration-300',
      maximum:
        'bg-gradient-zen brutal-border brutal-shadow-strong transform -rotate-2 hover:rotate-0 hover:scale-105 transition-all duration-500',
    },
    'glass-ink': {
      minimal: 'ink-glass-primary rounded-lg p-zen-sm',
      moderate:
        'ink-glass-elevated rounded-xl p-zen-md hover:ink-glass-immersive transition-all duration-500',
      maximum:
        'ink-glass-immersive rounded-2xl p-zen-lg backdrop-blur-3xl hover:scale-105 transition-all duration-700',
    },
    fusion: {
      minimal: 'ink-glass-primary brutal-border rounded-none p-zen-lg',
      moderate:
        'ink-glass-elevated brutal-border rounded-lg p-zen-xl hover:brutal-shadow transform hover:rotate-1',
      maximum:
        'ink-glass-immersive brutal-border brutal-shadow-strong rounded-xl p-zen-2xl transform hover:scale-105 hover:rotate-0',
    },
  }
            ...
            <div
              className={cn(
                ...
                variant === 'brutal'
                  ...
                  : 'rounded-t-lg',
                traditionalDepth &&
                  'after:absolute after:inset-0 after:bg-gradient-to-t after:from-ink/10 after:to-transparent after:opacity-0 hover:after:opacity-100 after:transition-opacity after:duration-500'
              )}
            >
              {artwork.imageId ? (
                <GalleryArtworkImage
                ...
                {showActions && (
                  <div
                    className={cn(
                      ...
                      variant === 'brutal'
                        ? 'brutal-border border-l-0 border-r-0 border-b-0'
...
export function ZenBrutalistGallery({
  ...
  const gridVariants = {
    ...
    brutal:
      'grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-zen-xl p-zen-lg',
    'glass-ink':
      'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-zen-lg p-zen-md',
