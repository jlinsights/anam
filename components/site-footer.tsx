  ...
  return (
    <footer className='bg-ink text-paper dark:bg-neutral-900 dark:text-neutral-100 py-12'>
      <div className='container mx-auto px-4'>
            ...
            <ul className='space-y-2'>
              <li>
                <Link
                  ...
                  className='text-xs text-paper/70 dark:text-paper/70 hover:text-paper dark:hover:text-white transition-colors'
                >
                  현재 전시
                </Link>
              </li>
        ...
        {/* 뉴스레터 구독 및 법적 페이지 링크 */}
        <div className='border-t border-paper/10 dark:border-paper/10 pt-6 mt-8'>
          <div className='flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 mb-6'>
            ...
            <div className='flex flex-col md:flex-row items-center gap-4'>
              <Link
                ...
                className='text-xs uppercase tracking-wider hover:text-paper/80 transition-colors'
              >
                뉴스레터 구독
              </Link>
            </div>
            ...
            {/* 구분선 */}
            <div className='hidden md:block w-px h-8 bg-paper/20'></div>

            {/* 법적 페이지 링크 */}
            <div className='flex flex-wrap justify-center gap-4 md:gap-6'>
              <Link
                href='/terms-of-service'
                className='text-xs text-[#fcfcfc]/70 hover:text-paper transition-colors'
              >
                이용약관
              </Link>
              <Link
        ...
        {/* 저작권 및 파트너 로고 */}
        <div className='border-t border-paper/10 dark:border-paper/10 pt-6 mt-6'>
          {/* 파트너 */}
          ...
          <div className='text-center'>
            <p className='text-xs text-paper/60 dark:text-paper/60'>
