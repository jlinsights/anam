    ...
    <div className={cn('space-y-4', className)}>
      ...
      <div className='relative'>
        ...
        <div className='relative flex-1'>
          <Search className='absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground dark:text-neutral-400' />
          <Input
            type='text'
        ...
        >
          ...
          필터
          {filters.selectedMediums.length > 0 && (
            <span className='ml-1 rounded-full bg-primary px-2 py-0.5 text-xs text-primary-foreground dark:bg-neutral-700 dark:text-neutral-200'>
        ...
        >
          <div className='space-y-6'>
            ...
            <div className='flex justify-end gap-2 pt-4 border-t border-border'>
              ...
              <Button onClick={() => setIsFilterOpen(false)}>적용</Button>
            </div>
          </div>
        </AccessibleModal>
      </div>
