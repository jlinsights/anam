...
export function CulturalArtworkCard({
  ...
  const [activeStroke, setActiveStroke] = useState<
    'press' | 'horizontal' | 'vertical' | 'curve' | null
  >(null)
    ...
    <div
      ...
      style={{
        background: `
          linear-gradient(
            ${
              activeStroke === 'horizontal'
                ? '90deg'
                : activeStroke === 'vertical'
                  ? '0deg'
                  : activeStroke === 'curve'
                    ? '45deg'
                    : '180deg'
            ...
            >
              <GalleryGridImage
                ...
                className={cn(
                  ...
                  isHovered &&
                    variant === 'traditional' &&
                    'scale-105 filter brightness-105 sepia(0.1)',
                  isHovered &&
                    variant === 'seasonal' &&
                    `scale-110 filter saturate-150 ${culturalSeason !== 'eternal' ? `season-${culturalSeason}` : ''}`,
                  isHovered &&
                    variant === 'balanced' &&
                    'scale-105 filter brightness-110 contrast-110',
                  isHovered &&
                    variant === 'immersive' &&
                    'scale-105 filter brightness-105 saturate-120 hue-rotate-2'
                )}
                priority={priority}
              />
...
export function CulturalGallery({
  ...
  const containerVariants = {
    traditional:
      'cultural-context temporal-depth zen-brutalist-layout py-zen-4xl',
    ...
    immersive:
      'cultural-layer-flow zen-brutalist-layout py-zen-4xl bg-gradient-ink',
  }
...
export function CulturalArtworkCardSkeleton({
  ...
  const skeletonVariants = {
    ...
    seasonal:
      'cultural-immersion rounded-2xl void-contemplative seasonal-shift',
