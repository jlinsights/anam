...
export function ImmersiveArtworkCard({
  ...
  const cardVariants = {
    'zen-immersive': {
      subtle:
        'glass-depth-container ink-glass-primary rounded-xl p-zen-md zen-breathe-deep',
      moderate:
        'glass-depth-container ink-glass-elevated rounded-xl p-zen-lg immersive-hover fluid-ink-transition',
      intense:
        'glass-depth-container ink-glass-immersive rounded-2xl p-zen-xl immersive-hover fluid-ink-transition ink-flow-ambient',
      maximum:
        'glass-depth-container ink-glass-immersive rounded-2xl p-zen-2xl immersive-hover fluid-ink-transition ink-flow-ambient depth-layer-shift',
    },
    'brutal-glass': {
      subtle: 'bg-paper brutal-border glass-layer-1 p-zen-md ink-ripple-effect',
      moderate:
        'glass-layer-2 brutal-border brutal-shadow p-zen-lg immersive-hover ink-ripple-effect transform hover:rotate-1',
      intense:
        'glass-layer-3 brutal-border brutal-shadow-strong p-zen-xl immersive-hover ink-ripple-effect transform hover:rotate-2 hover:scale-105',
      maximum:
        'glass-depth-container glass-layer-3 brutal-border brutal-shadow-strong p-zen-2xl immersive-hover fluid-ink-transition transform hover:rotate-2 hover:scale-110 depth-layer-shift',
    },
    'ink-flow': {
      subtle: 'ink-glass-primary rounded-lg p-zen-md ink-flow-ambient',
      moderate:
        'ink-glass-elevated rounded-xl p-zen-lg fluid-ink-transition ink-brush-flow',
      intense:
        'ink-glass-immersive rounded-xl p-zen-xl fluid-ink-transition ink-flow-ambient immersive-hover',
      maximum:
        'glass-depth-container ink-glass-immersive rounded-2xl p-zen-2xl fluid-ink-transition ink-flow-ambient immersive-hover zen-breathe-deep',
    },
    'depth-fusion': {
      subtle: 'glass-layer-1 rounded-lg p-zen-md zen-breathe-deep',
      moderate:
        'glass-depth-container glass-layer-2 rounded-xl p-zen-lg immersive-hover',
      intense:
        'glass-depth-container glass-layer-3 rounded-xl p-zen-xl immersive-hover fluid-ink-transition',
      maximum:
        'glass-depth-container glass-layer-3 rounded-2xl p-zen-2xl immersive-hover fluid-ink-transition ink-flow-ambient depth-layer-shift',
    },
  }
  ...
  const imageVariants = {
    ...
    'brutal-glass':
      'aspect-[3/4] rounded-none overflow-hidden brutal-border border-b-0',
              ...
              <GalleryGridImage
                ...
                className={cn(
                  ...
                  isHovered &&
                    ...
                    'scale-110 rotate-1 filter contrast-110',
                  isHovered &&
                    variant === 'ink-flow' &&
                    'scale-105 filter saturate-150',
                  isHovered &&
                    variant === 'depth-fusion' &&
                    'scale-105 filter brightness-105 saturate-120'
                )}
                priority={priority}
              />
                  ...
                  {artwork.featured && (
                    <Badge
                      ...
                      className={cn(
                        ...
                        variant === 'brutal-glass' &&
                          'brutal-border bg-gold text-ink font-black uppercase',
...
export function ImmersiveGallery({
  ...
  const layoutVariants = {
    ...
    structured:
      'grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-zen-lg',
