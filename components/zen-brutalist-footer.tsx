      ...
      <div className={cn('zen-brutalist-layout', currentStyle.spacing)}>
              ...
              {phaseNavigation.map((phase) => (
                <Link
                  ...
                  className={cn(
                    ...
                    variant === 'zen' && 'ink-glass-primary hover:shadow-zen-depth',
                    variant === 'brutal' && 'brutal-border hover:brutal-shadow',
                    variant === 'immersive' && 'glass-layer-1 hover:glass-layer-2',
                    variant === 'cultural' && 'cultural-context hover:temporal-depth'
                  )}
          ...
          <div className="md:col-span-1 lg:col-span-1">
            <div className={cn(
              ...
              <p className={cn(
                ...
                아남 배옥영 작가의 현대 서예 작품을 통해 전통과 현대가 만나는 새로운 미학적 경험을 제공합니다.
              </p>
          ...
          <div>
            ...
            <div className="space-y-zen-md">
              <div>
                ...
                <p className={cn('zen-typography-body', currentStyle.textLight)}>
        ...
        <div className={cn(
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-zen-md">
            {/* Copyright */}
            <div className={cn('text-center md:text-left', currentStyle.textLighter)}>
              <p className="text-sm">
                © 2024 ANAM Gallery. 모든 권리 보유.
              </p>
