...
const config: Config = {
  ...
  safelist: [
    ...
    'card-art-elevated',
    // 새로운 서예 타이포그래피 클래스들
    'text-calligraphy-bold',
    'text-calligraphy-light',
    'text-calligraphy-ink',
    'text-calligraphy-gold',
    'text-calligraphy-title',
    'text-calligraphy-body',
    'text-calligraphy-caption',
    // 계절별 색상 클래스들
    'text-spring-primary',
    'text-spring-secondary',
    'text-spring-accent',
    'text-spring-muted',
    'bg-spring-primary',
    'bg-spring-secondary',
    ...
    'border-spring-secondary',
    'border-spring-accent',
    'border-spring-muted',
    'text-summer-primary',
    'text-summer-secondary',
    'text-summer-accent',
    'text-summer-muted',
    'bg-summer-primary',
    'bg-summer-secondary',
    'bg-summer-accent',
    'bg-summer-muted',
    'border-summer-primary',
    'border-summer-secondary',
    'border-summer-accent',
    'border-summer-muted',
    'text-autumn-primary',
    ...
    'border-autumn-secondary',
    'border-autumn-accent',
    'border-autumn-muted',
    'text-winter-primary',
    ...
    'bg-winter-accent',
    'bg-winter-muted',
    'border-winter-primary',
    'border-winter-secondary',
    'border-winter-accent',
    'border-winter-muted',
    'seasonal-transition',
    'seasonal-transition-color',
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'zen-depth':
          '0 1px 3px rgba(0, 0, 0, 0.12), 0 8px 24px rgba(0, 0, 0, 0.08)',
      },
      transitionDuration: {
        '2000': '2000ms',
        '3000': '3000ms',
