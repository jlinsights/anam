import {
  ...
  ZenBrutalistGallery,
} from '@/components/zen-brutalist-artwork-card'
...
export const metadata: Metadata = {
  ...
  description:
    'Demonstration of the new Zen Brutalism + Glass Morphism design system',
}
    ...
    <main className='min-h-screen bg-paper flex flex-col'>
        ...
        <div className='zen-brutalist-layout'>
          ...
          <div className='mb-zen-3xl'>
            ...
            <p className='zen-typography-body text-ink-light mb-zen-xl max-w-3xl'>
              명상적 여백과 섬세한 글래스 모피즘으로 구현된 현대적 선미학. 깊은
              호흡과 절대적 침묵의 공간에서 작품과 대화하는 경험.
            </p>
          ...
          <div className='mb-zen-3xl'>
            ...
            <p className='zen-typography-body text-ink-light mb-zen-xl max-w-3xl'>
              강렬한 그림자와 기하학적 구조로 표현된 절제된 브루탈리즘. 전통
              서예의 힘찬 필획을 현대적 공간언어로 재해석.
            </p>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-zen-xl'>
          ...
          <div className='mb-zen-3xl'>
            ...
            <p className='zen-typography-body text-ink-light mb-zen-xl max-w-3xl'>
              먹의 깊이와 유리의 투명성이 만나는 몰입형 인터페이스. 전통 재료의
              물성을 현대 기술로 재현한 감각적 경험.
            </p>
          ...
          <div>
            ...
            <p className='zen-typography-body text-ink-light mb-zen-xl max-w-3xl'>
              선적 미니멀리즘과 브루탈리즘, 글래스 모피즘이 조화롭게 융합된
              하이브리드 디자인. 전통의 깊이와 현대적 몰입감의 완벽한 균형.
            </p>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-zen-2xl'>
            ...
            <div className='bg-paper brutal-border brutal-shadow p-zen-xl'>
              ...
              <div className='space-y-zen-md'>
                ...
                <div className='brutal-typography-impact text-ink-dark'>
                  STRENGTH
                </div>
                <div className='brutal-typography-accent text-ink'>
                  MODERN POETRY
                </div>
                <div className='zen-typography-body text-ink-lighter'>
                  강렬한 구조와 절제된 아름다움으로 전통 서예의 힘찬 정신을
                  현대적 언어로 재해석합니다.
                </div>
              </div>
            </div>
          ...
          <div className='space-y-zen-lg'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-zen-md'>
              {[
                ...
                <div
                  key={space.scale}
                  className='ink-glass-primary rounded-lg p-zen-sm'
                >
      ...
      <section className='py-zen-3xl bg-ink text-paper' id='showcase'>
        <div className='zen-brutalist-layout text-center space-y-zen-xl'>
          <h2 className='zen-typography-hero'>전통의 깊이, 현대의 몰입</h2>
          <p className='zen-typography-body max-w-2xl mx-auto opacity-80'>
            아남 배옥영 작가의 서예 작품을 통해 경험하는 새로운 디지털 갤러리의
            미학
          </p>
