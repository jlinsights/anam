import { ImmersiveArtworkCard, ImmersiveGallery } from '@/components/immersive-artwork-card'
...
export const metadata: Metadata = {
  ...
  description: 'Advanced glass morphism effects with fluid ink transitions and multi-layer depth',
}
    ...
    <main className="min-h-screen bg-paper relative overflow-hidden flex flex-col">
        ...
        <div className="zen-brutalist-layout">
          ...
          <div className="mb-zen-4xl">
            <div className="text-center mb-zen-xl">
              ...
              <p className="zen-typography-body text-ink-light max-w-4xl mx-auto">
                다층 유리 깊이감과 부드러운 먹 그라디언트가 조화를 이루는 명상적 인터페이스. 
                마우스 추적 기반 문화적 레이어 시스템으로 전통 미학의 현대적 재해석.
              </p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-zen-lg">
              {['subtle', 'moderate', 'intense', 'maximum'].map((intensity, idx) => (
          ...
          <div className="mb-zen-4xl">
            <div className="text-center mb-zen-xl">
              ...
              <p className="zen-typography-body text-ink-light max-w-4xl mx-auto">
                강렬한 기하학적 구조와 정밀한 유리 효과의 융합. 
                브루탈리즘의 힘과 글래스 모피즘의 섬세함이 만나는 혁신적 조합.
              </p>
            </div>
          ...
          <div className="mb-zen-4xl">
            <div className="text-center mb-zen-xl">
              ...
              <p className="zen-typography-body text-ink-light max-w-4xl mx-auto">
                실시간 마우스 추적으로 생성되는 동적 먹 그라디언트. 
                전통 서예의 붓질 움직임을 디지털 상호작용으로 재현한 혁신적 시스템.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-zen-xl">
            ...
            <div className="glass-depth-container glass-layer-3 rounded-xl p-zen-lg immersive-hover">
              ...
              <p className="zen-typography-body opacity-80 mb-zen-md">
                3단계 깊이감을 구현한 고급 글래스 모피즘 시스템. 
                각 레이어는 독립적인 블러와 투명도를 가져 입체적 경험 제공.
              </p>
            ...
            <div className="zen-breathe-deep ink-glass-elevated rounded-xl p-zen-lg">
              ...
              <p className="zen-typography-body opacity-80 mb-zen-md">
                전통 한국 미학의 깊이감을 현대적 인터랙션으로 표현. 
                여백의 미학과 층위적 구성의 디지털 구현.
              </p>
              <ul className="space-y-zen-xs text-sm opacity-70">
      ...
      <section className="relative z-10 py-zen-3xl bg-gradient-zen">
        <div className="zen-brutalist-layout">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-zen-lg">
            {[
              { name: 'Ink Flow Duration', value: '3000ms', desc: '유동적 먹 애니메이션' },
              { name: 'Glass Morph Duration', value: '2000ms', desc: '유리 변형 효과' },
              { name: 'Depth Transition', value: '1500ms', desc: '깊이감 전환' },
              { name: 'Mouse Tracking', value: '<16ms', desc: '실시간 마우스 추적' }
            ].map((metric) => (
              <div key={metric.name} className="ink-glass-primary rounded-lg p-zen-md text-center">
                ...
                <div className="text-ink-lighter text-sm">
                  {metric.desc}
                </div>
              </div>
            ))}
      ...
      {/* Call to Action */}
      <section className="relative z-10 py-zen-4xl bg-ink text-paper" id="effects">
        <div className="zen-brutalist-layout text-center space-y-zen-xl">
          <div className="glass-depth-container glass-layer-3 rounded-2xl p-zen-2xl immersive-hover">
            ...
            <p className="zen-typography-body max-w-3xl mx-auto opacity-80 mb-zen-xl">
              전통 한국 서예의 깊이와 현대 기술의 몰입감이 만나는 
              혁신적인 디지털 갤러리 경험을 지금 시작하세요.
            </p>
